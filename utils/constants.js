...
export const UNLOCK_NETWORK_ID = 5;

export const SIWE = {
  DOMAIN: "app.protocol.com",
  URI: "https://app.protocol.com",
  SIGN_MESSAGE: "app.unlock-protocol.com wants you to sign in with your Ethereum account:",
};

export const LOCK_ADDRESS = "0xbf4f7de72331e6e81e87bf0dcc28f79e7543e094";
...
export const ABI = [
  ...
  { anonymous: false, inputs: [{ indexed: false, internalType: "uint256", name: "updatedRecordsCount", type: "uint256" }], name: "KeysMigrated", type: "event" },
  {
    anonymous: false,
    inputs: [
  ...
  { inputs: [], name: "maxKeysPerAddress", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
  ...
  { inputs: [{ internalType: "bytes", name: "", type: "bytes" }], name: "migrate", outputs: [], stateMutability: "nonpayable", type: "function" },
  ...
  { inputs: [], name: "onKeyExtendHook", outputs: [{ internalType: "contract ILockKeyExtendHook", name: "", type: "address" }], stateMutability: "view", type: "function" },
  { inputs: [], name: "onKeyGrantHook", outputs: [{ internalType: "contract ILockKeyGrantHook", name: "", type: "address" }], stateMutability: "view", type: "function" },
  ...
  { inputs: [], name: "onKeyTransferHook", outputs: [{ internalType: "contract ILockKeyTransferHook", name: "", type: "address" }], stateMutability: "view", type: "function" },
  ...
  { inputs: [], name: "schemaVersion", outputs: [{ internalType: "uint256", name: "", type: "uint256" }], stateMutability: "view", type: "function" },
  {
    inputs: [
      { internalType: "address", name: "_to", type: "address" },
  ...
  { inputs: [{ internalType: "address", name: "account", type: "address" }], name: "setOwner", outputs: [], stateMutability: "nonpayable", type: "function" },
  {
    inputs: [
      { internalType: "address", name: "_referrer", type: "address" },
  ...
  { inputs: [], name: "totalSupply", outputs: [{ internalType: "uint256", name: "_totalKeysCreated", type: "uint256" }], stateMutability: "view", type: "function" },
